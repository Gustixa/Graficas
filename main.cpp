...
int main(int argc, char* argv[]) {
	...
	scene.textures["Mercury"     ] = loadImage("./resources/Mercury.png");
	scene.textures["Venus"       ] = loadImage("./resources/Venus.png"  );
	scene.textures["Earth"       ] = loadImage("./resources/Earth.png"  );
	scene.textures["Earth Clouds"] = loadImage("./resources/Clouds.png" );
	scene.textures["Moon"        ] = loadImage("./resources/Moon.png"   );
	scene.textures["Mars"        ] = loadImage("./resources/Mars.png"   );
	scene.textures["Jupiter"     ] = loadImage("./resources/Jupiter.png");
	scene.textures["Saturn"      ] = loadImage("./resources/Saturn.png" );
	scene.textures["Saturn Rings"] = loadImage("./resources/Rings.png"  );
	scene.textures["Uranus"      ] = loadImage("./resources/Uranus.png" );
	scene.textures["Neptune"     ] = loadImage("./resources/Neptune.png");
	scene.textures["Pluto"       ] = loadImage("./resources/Mercury.png");
...
void render(Scene& scene) {
	...
	if (!pause) {
		...
		rotateAroundAnchor(scene.objects["Earth Clouds"].position, scene.objects["Sun"].position, vec3(0, 1.0 / 3.6525 * delta_time, 0));
		...
		scene.objects["Earth Clouds"].rotation += vec3(-24.00 * delta_time, 0, 0);
	...
	renderMesh(renderer, scene, scene.objects["Earth Clouds"], vec3(1.0, 1.0, 1.0), Shader::SUN, scene.textures["Earth Clouds"]);
